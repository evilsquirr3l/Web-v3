...
namespace Data.Implementation.Migrations
{
    ...
    [Migration("20200519175804_CityChangePopulationTypeToInt")]
    partial class CityChangePopulationTypeToInt
    {
            ...
            modelBuilder.Entity("Data.Entities.Resident", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2002, 5, 19, 20, 57, 50, 938, DateTimeKind.Local).AddTicks(6270),
                            Name = "Max Snizhok"
                        },
                        new
                        {
                            Id = 2,
                            BirthDate = new DateTime(1993, 5, 19, 20, 57, 50, 947, DateTimeKind.Local).AddTicks(2920),
                            Name = "Kurtka Bayne"
                        });
                });
