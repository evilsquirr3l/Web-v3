...
namespace Data.Implementation.Migrations
{
    ...
    [Migration("20200520144253_ApartmentResidentsAddId")]
    partial class ApartmentResidentsAddId
    {
            ...
            modelBuilder.Entity("Data.Entities.Resident", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2002, 5, 20, 17, 42, 40, 153, DateTimeKind.Local).AddTicks(4990),
                            Name = "Max Snizhok"
                        },
                        new
                        {
                            Id = 2,
                            BirthDate = new DateTime(1993, 5, 20, 17, 42, 40, 160, DateTimeKind.Local).AddTicks(8970),
                            Name = "Kurtka Bayne"
                        });
                });
