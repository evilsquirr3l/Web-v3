...
namespace Data.Implementation.Migrations
{
    ...
    [Migration("20200519172823_ApartmentAddSquare")]
    partial class ApartmentAddSquare
    {
            ...
            modelBuilder.Entity("Data.Entities.Resident", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2002, 5, 19, 20, 28, 10, 555, DateTimeKind.Local).AddTicks(3550),
                            Name = "Max Snizhok"
                        },
                        new
                        {
                            Id = 2,
                            BirthDate = new DateTime(1993, 5, 19, 20, 28, 10, 566, DateTimeKind.Local).AddTicks(1700),
                            Name = "Kurtka Bayne"
                        });
                });
